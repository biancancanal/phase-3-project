...
const Lesson = (props) => {
    ...
    <div>
        ...
        {lessonEditFlag ? <LessonEdit lesson={props.lesson} toggleForm={() => setLessonEditFlag(false)} editLesson={props.editLesson}/> : <button onClick={() => setLessonEditFlag(true)}>Edit</button>}
